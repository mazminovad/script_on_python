...
# Идентификатор существующей Google таблицы
spreadsheet_id = '*******'
...
"Phone", "Name", "Surname"
from accounts where "Deleted" = 'false' and "CreatedAt">= now() AT TIME ZONE 'UTC' - INTERVAL '14d'""")
rows = cur.fetchall()
...
result = spreadsheetService.spreadsheets().values().append(
...
print("Идентификатор таблицы: ", spreadsheet_id)
print("Таблица обновлена с использованием файла ключа:", CREDENTIALS_PATH)
